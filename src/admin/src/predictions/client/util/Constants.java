...
public class Constants {
    ...
    public final static String ALLOCATIONS_FXML_LOCATION =  "/predictions/client/components/allocations/allocationsScreen.fxml";
    ...
    public final static String ALLOCATIONS_CSS_LOCATION = "/predictions/client/components/allocations/allocations.css";
